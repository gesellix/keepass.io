...
var DatabaseManager = dejavu.Class.declare({
    ...
    __readFileIntoMemory: function(cb) {
    ...
    __checkSignatures: function(fileBuffer, cb) {
    ...
    __dispatchToVersionHandler: function(fileBuffer, versionSignature, cb) {
        this.__database = new (this.$static.VERSION_SIGNATURES[versionSignature])(fileBuffer);
        this.__database.parse(function(err) {
            return cb(err);
        });
    }.$bound()
});
